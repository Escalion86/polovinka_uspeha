        ...
        <div className="flex items-center">
          ...
          /> */}
            <div className="italic text-center taxt-lg tablet:text-2xl">
              Мой центр помог мне найти свою вторую половинку, и я знаю, что
              каждый может здесь найти не только свою половинку, но и партнеров
              по бизнесу, а также близкий круг друзей и единомышленников по
              своим интересам.
            </div>
            {/* <img
