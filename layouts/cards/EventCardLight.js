...
const EventCardLight = ({ eventId, onTagClick, style }) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          'bg-white border-t border-b border-gray-400 relative w-full duration-300 shadow-xs hover:shadow-medium-active flex flex-col laptop:flex-row items-center laptop:items-stretch gap-x-2',
