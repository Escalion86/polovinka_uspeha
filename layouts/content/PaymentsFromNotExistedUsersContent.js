...
import paymentsFromNotExistedUsersSelector from '@state/selectors/paymentsFromNotExistedUsersSelector'

const PaymentsFromNotExistedUsersContent = () => {
  // const modalsFunc = useAtomValue(modalsFuncAtom)
  const paymentsForNotExistedEvents = useAtomValue(
    paymentsFromNotExistedUsersSelector
  )
...
export default PaymentsFromNotExistedUsersContent
