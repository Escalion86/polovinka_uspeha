...
const EventsCalendarView = ({
  ...
  return (
    <div className="grid gap-6 mx-1 lg:grid-cols-2">
      <div className="rounded-2xl bg-white p-4 shadow-[0_16px_30px_rgba(0,0,0,0.08)]">
      ...
      <div className="rounded-2xl bg-white shadow-[0_16px_30px_rgba(0,0,0,0.08)]">
        <h3 className="px-6 pt-6 text-lg font-bold text-[#6b1f2a]">
          {selectedDay
            ? `События на ${selectedDay} ${monthName}`
            : 'Выберите активную дату'}
        </h3>
        {loadingMonth ? (
          <p className="mt-2 px-6 pb-6 text-[#666]">Загрузка мероприятий...</p>
