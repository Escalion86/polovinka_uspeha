...
const browseLocationFunc = () => {
    ...
    return (
      <FormWrapper>
        <div className="flex flex-col gap-y-2">
          <div>
            Для того чтобы предложить Вам мероприятия из район Вашего
            проживания, необходимо выбрать район из предложенных вариантов:
          </div>
          ...
          <div>
            Если Вашего района нет в списке, значит наш проект пока еще не
            присутствует в вашем районе
          </div>
        </div>
      </FormWrapper>
    )
  ...
  return {
    title: `Выберите район вашего проживания`,
