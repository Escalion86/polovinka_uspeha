    ...
    >
      <div className="grid" style={{ gridTemplateColumns: '7% 93%' }}>
        ...
        <div className="relative h-10">
          ...
          {type === 'location' ? (
            <select
              className="absolute ring-0 w-full h-full top-0 left-0 border-none outline-hidden bg-transparent py-0.5 px-3 text-lg text-gray-600"
              style={{
        ...
        <Modal onClose={() => setShowAgreement(false)}>
          <div className="flex flex-col items-center p-2 tablet:p-4">
            ...
            <div>
              ...
              руководителю центру серьёзных знакомств «Половинка успеха» (ИНН
