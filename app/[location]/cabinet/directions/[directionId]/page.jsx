...
export default async function CabinetDirectionsPage({ params }) {
  ...
  if (!session?.user) {
    redirect(`/${location}/login?page=directions`)
  }

  if (session.location !== location) {
    redirect(`/${session.location}/cabinet/directions/${directionId}`)
  }
